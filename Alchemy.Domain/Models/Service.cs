namespace Alchemy.Domain.Models
{
    public class Service
    {
        ...
        private Service() { }
        private Service(long id, string title, string description, decimal price, int duration)
        {
            Id = id;
            Title = title;
        ...
        public static (Service Service, string error) Create(long id, string title, string description, decimal price, int duration)
        {
