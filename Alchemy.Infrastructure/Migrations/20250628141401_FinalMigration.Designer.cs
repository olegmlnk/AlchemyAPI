...
namespace Alchemy.Infrastructure.Migrations
{
    ...
    [Migration("20250628141401_FinalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alchemy.Domain.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("Alchemy.Domain.Models.MasterSchedule", "ScheduleSlot")
                        .WithOne("Appointment")
                        .HasForeignKey("Alchemy.Domain.Models.Appointment", "ScheduleSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Alchemy.Domain.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
